...
export default function Home() {
  return (
    <main className="site variation-2">
      ...
      <section className="scroll-reel" aria-label="RHYME in motion">
        <div className="reel-sticky">
          <div className="reel-copy reel-copy-a"><span>01 / LISTEN</span><strong>Feel the<br /><em>room.</em></strong></div>
          <div className="reel-copy reel-copy-b"><span>02 / LEARN</span><strong>See the<br /><em>process.</em></strong></div>
          <div className="reel-copy reel-copy-c"><span>03 / BELONG</span><strong>Meet the<br /><em>people.</em></strong></div>
          <div className="reel-frame reel-frame-a"><video src="/media/rhyme-1.mp4" autoPlay muted loop playsInline /></div>
          <div className="reel-frame reel-frame-b"><video src="/media/rhyme-2.mp4" autoPlay muted loop playsInline /></div>
          <div className="reel-frame reel-frame-c"><video src="/media/rhyme-3.mp4" autoPlay muted loop playsInline /></div>
          <p className="reel-counter">SCROLL TO ENTER <b>001</b></p>
        </div>
      </section>
      ...
      <section className="sessions" id="sessions" data-reveal>
      ...
      <section className="access" id="membership" data-reveal>
      ...
      <section className="creator-economy" id="creators" data-reveal>
      ...
      <section className="manifesto" data-reveal><p>The RHYME community</p><h2>Where listening<br />becomes <em>belonging.</em></h2><span>More understanding. More human connection. More meaningful support for music.</span></section>
      ...
      <section className="join" id="join" data-reveal><span>Pre-launch access</span><h2>Claim your name.<br />Join the first wave.</h2><p>Reserve the username you want to use across the RHYME community.</p><div className="join-actions"><a className="cta" href="/reserve"><span>Reserve your username</span><b>{"\u2197"}</b></a><a className="text-link" href="/reserve?type=creator">I am a creator <span>{"\u2197"}</span></a></div><small>RHYME is in private pre-launch. Reservations will be confirmed by email before public launch.</small></section>
